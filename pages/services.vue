  ...
  <div class="page">
    <div class="services">
      ...
      <ul class="services_icon">
        <li class="services_icon_item">
          <div class="border">
            <div class="services_icon_item_label">Hearing</div>
            <div class="services_icon_item_subLabel">ヒアリング</div>
          </div>
        </li>
        <li class="services_icon_item">
          <div class="border">
            <div class="services_icon_item_label">Proposal</div>
            <div class="services_icon_item_subLabel">企画</div>
          </div>
        </li>
        <li class="services_icon_item">
          <div class="border">
            <div class="services_icon_item_label">Shooting</div>
            <div class="services_icon_item_subLabel">撮影</div>
          </div>
        </li>
        <li class="services_icon_item">
          <div class="border">
      ...
      <div class="services_txt">
        filuxは企画から撮影編集まで、<br data-device="sp">ワンストップで提供し<br>
        お客様のご要望を実現します
      </div>
    </div>
    <div class="hearing">
      <div class="hearing_cont">
        <h3 class="hearing_cont_label">
          hearing
        </h3>
        <h4 class="hearing_cont_subLabel">
          ヒアリング
        </h4>
        <div class="hearing_cont_exp" data-device="pc">
          <div class="hearing_cont_exp_txt"> 
            まずお客様との丁寧なヒアリングを行い、<br>
            ニーズや目的をしっかりと把握します。<br>
            動画を制作する目的やターゲットとなる視聴者、<br>
            伝えたいメッセージを詳しく伺い、お客様のビジョンを共有します。<br>
            どんな些細な要望でも気軽にお伝えいただける環境を整えており、<br>
            コミュニケーションを通じて、<br>
    ...
    <div class="proposal">
      <div class="proposal_cont">
        <h3 class="proposal_cont_label">
          Proposal
        </h3>
        <h4 class="proposal_cont_subLabel">
          企画
        </h4>
        <div class="proposal_cont_exp" data-device="pc">
          ...
          <div class="proposal_cont_exp_txt"> 
            ...
            ロケーションなど、映像のコンセプトを<br>
            しっかりと企画段階で固めます。<br>
            単に見栄えの良い動画ではなく、視聴者に響く内容を追求し、<br>
            コンバージョンやブランディングの向上に<br>
            貢献するプランを提案します。<br>
            企画段階でしっかりと戦略を立てることで、<br>
            納得のいく仕上がりを実現します。
          </div>
        </div>
        <div class="proposal_cont_img" data-device="sp">
          <div class="proposal_cont_img_txt">
            ...
            ロケーションなど、映像のコンセプトを<br>
            しっかりと企画段階で固めます。<br>
            単に見栄えの良い動画ではなく、<br>視聴者に響く内容を追求し、<br>
            コンバージョンやブランディングの向上に<br>
            貢献するプランを提案します。<br>
            企画段階でしっかりと戦略を立てることで、<br>
            納得のいく仕上がりを実現します。
    ...
    <div class="shooting">
      <div class="shooting_cont">
        ...
        <div class="shooting_cont_exp" data-device="pc">
        ...
        <div class="shooting_cont_img" data-device="sp">
          <div class="shooting_cont_img_txt">
            ...
            スタジオ撮影からロケーション撮影まで、<br>
            お客様のご要望に合わせた撮影を行います。<br>
            映像のクオリティにこだわり、<br>細部にまで目を向けた<br>
            美しい映像を提供します。<br>
            撮影中もお客様と密に連携を取りながら、<br>
            スムーズな進行を心がけています。
          </div>
      ...
      <div class="edit_cont">
        ...
        <div class="edit_cont_img" data-device="sp">
          <div class="edit_cont_img_txt">
            ...
            ストーリー性を強調し、
            視聴者を引き込む効果を高めることを目指します。<br>
            カラーグレーディングや音声処理、<br>BGMや効果音の追加など、<br>
            細部にこだわった編集作業を通して、<br>完成度の高い作品に仕上げます。<br>
            お客様との確認を繰り返しながら、納得のいく映像をご提供いたします。
          </div>
        </div>
      </div>
    ...
    <div class="management">
      <div class="management_cont">
        ...
        <div class="management_cont_exp" data-device="pc">
